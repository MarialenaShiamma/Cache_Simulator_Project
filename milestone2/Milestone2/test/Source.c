...
int MISS_CYCLES_READ_CACHE, MISS_CYCLES_READ_RAM;
int MISS_CYCLES_WRITE_CACHE, MISS_CYCLES_WRITE_RAM;
...
ParserParameters(&RAM_SIZE, &CACHE_SIZE, &WORD_SIZE, &Number_of_words_blocks_per_block, &temp, &Direct_Mapped, &N_Way_Set_Associative, &Fully_Associative, &NumberOfFlushes, &FIFO, &LRU, &RANDOM, &WRITE_BACK, &WRITE_THROUGH, &WRITE_ALLOCATE, &NO_WRITE_ALLOCATE, &MISS_CYCLES_READ_CACHE, &MISS_CYCLES_READ_RAM, &MISS_CYCLES_WRITE_CACHE, &MISS_CYCLES_WRITE_RAM, &Ways);
//printf("RAM  %d CACHE %d word %d blocks %d temp %d DM %d NWAY %d FULLY %d FLUSHES %d FIFO %d LRU %d RANDOM %d WB %d WT %d WA %d NWA %d MCRC %d MCRR %d MCWC %d MCWR %d\n", RAM_SIZE, CACHE_SIZE, WORD_SIZE, Number_of_words_blocks_per_block, temp, Direct_Mapped, N_Way_Set_Associative, Fully_Associative,NumberOfFlushes, FIFO, LRU, RANDOM, WRITE_BACK, WRITE_THROUGH, WRITE_ALLOCATE, NO_WRITE_ALLOCATE, MISS_CYCLES_READ_CACHE, MISS_CYCLES_READ_RAM, MISS_CYCLES_WRITE_CACHE, MISS_CYCLES_WRITE_RAM);


//Call the structures function to do the calculations
Structures(RAM_SIZE, CACHE_SIZE, Number_of_words_blocks_per_block, WORD_SIZE, temp, Direct_Mapped, N_Way_Set_Associative, Fully_Associative, &IndexBitsAmount, &TagBitsAmount, &BOBitsAmount, &AddressBitsAmount, &RamWordCapacity, &CacheLines, &CacheWordCapacity, Ways, FIFO, LRU, RANDOM, WRITE_BACK, WRITE_THROUGH, WRITE_ALLOCATE, NO_WRITE_ALLOCATE);
...
Parser(temp, Direct_Mapped, N_Way_Set_Associative, Fully_Associative, AddressBitsAmount, IndexBitsAmount, TagBitsAmount, BOBitsAmount, Number_of_words_blocks_per_block, RamWordCapacity, CacheLines, CacheWordCapacity, Ways, WRITE_BACK,WRITE_THROUGH,WRITE_ALLOCATE,NO_WRITE_ALLOCATE,MISS_CYCLES_READ_CACHE,MISS_CYCLES_READ_RAM,MISS_CYCLES_WRITE_CACHE,MISS_CYCLES_WRITE_RAM, FIFO, LRU, RANDOM); //call the Parser function
