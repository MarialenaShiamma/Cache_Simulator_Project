...
void Structures(int RAM_SIZE, int CACHE_SIZE, int Number_of_words_blocks_per_block, int WORD_SIZE, int temp, int Direct_Mapped, int N_Way_Set_Associative, int Fully_Associative, int *first, int *second, int *third, int *AddrBits, int *RamWords,  int *CacheEntries, int *CacheWords, int AmountOfWays, int FIFO, int LRU, int RANDOM, int WRITE_BACK, int WRITE_THROUGH, int WRITE_ALLOCATE, int NO_WRITE_ALLOCATE){
	...
	//The case that our architecture is N_Way_Set_Associative
		...
		if (CacheWordCapacity /(WordsPerBlock * AmountOfWays) < 1){
